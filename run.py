...
def var_menu():
    ...
    _dvanme_ferly_('%s╠══[%s3%s] %sTutorial Penggunaan Script'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s4%s] %sInfo Author & Team Project'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s5%s] %sCek Hasil Crack'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s6%s] %sCek Opsi Hasil Crack'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s0%s] %sKeluar'%(O,P,O,P))
    _dvanme_ferly_('%s║'%(O))
def var_tutor():
    mlaku('%s╔══[%s Tips & Tutorial %s]'%(O,P,O))
    _dvanme_ferly_('%s║'%(O))
    _dvanme_ferly_('%s╠══[%s1%s] %sCara Mengambil Token'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s2%s] %sCara Mengambil Cookies'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s3%s] %sCara Mendapatkan Target'%(O,P,O,P))
    _dvanme_ferly_('%s╠══[%s4%s] %sCara Selama Proses Crack'%(O,P,O,P))
def tutor_target():
    mlaku('%s╠═══╦══════════════════════════════════════════════════════╗'%(O))
